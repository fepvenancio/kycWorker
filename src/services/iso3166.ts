// ISO 3166-1 alpha-3 to numeric code mappings
const iso3166Alpha3ToNumericCodeMap: Record<string, number> = {
  ...
  COL: 170, COM: 174, COD: 180, COG: 178, COK: 184, CRI: 188, CIV: 384, HRV: 191,
  ...
  NER: 562, NGA: 566, NIU: 570, NFK: 574, MNP: 580, NOR: 578, MKD: 807, OMN: 512,
  ...
  RWA: 646, BLM: 652, KNA: 659, LCA: 662, MAF: 663, SPM: 666, VCT: 670, SHN: 654,
  ...
  VEN: 862, VNM: 704, VGB: 92, VIR: 850, WLF: 876, ESH: 732, YEM: 887, ZMB: 894, ZWE: 716,
};


// Function to retrieve numeric code from alpha-3 code
export function getNumericCodeFromAlpha3(alpha3Code: string): number | undefined {
  return iso3166Alpha3ToNumericCodeMap[alpha3Code.toUpperCase()];
}
